...
- `nativewind` (Tailwind syntax on top of RN's `StyleSheet` — since the web app already uses Tailwind, this reuses that mental model rather than learning RN's plain style objects *and* a new design language at once)
